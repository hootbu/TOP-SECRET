...
class Canvas(tkinter.Canvas):
    ...
    def set_on_button_clicked(self, callback):
        """
        Set the specified function to be called whenever a button is clicked.  If this function is called
        multiple times, only the last specified function is called when a button is clicked.

        Args:
            callback: a function to call whenever a button is clicked.  Must take in one parameter, which
                is the text name of the button that was just clicked.
                E.g. func(button_name).  If this parameter is None, no function will be called when a button is clicked.
        """
    ...
    def is_hidden(self, obj):
        ...
        Args:
            obj: the graphical object to get the state of
    ...
    def get_fill_color(self, obj):
        """
        Gets the fill color of the specified graphical object.  Cannot be used to get the fill color
        of non-fillable objects such as images - throws a tkinter.TclError.
        ...
        Returns:
            The current fill color of the object, as a string.  If this is the empty string,
    ...
    def get_outline_color(self, obj):
        """
        Gets the outline color of the specified graphical object.  Cannot be used to get the outline color
        of non-outlined objects such as images or text  - throws a tkinter.TclError.

        Args:
            obj: the object for which to get the outline color

        Returns:
            the outline color of the given object, as a string.  If this is the empty string,
                the object does not have an outline.
        """
        try:
